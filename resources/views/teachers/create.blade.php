...
@section('content')
    ...
    <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div>
            <label for="gender"
                class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Pilihan: Laki-laki,
                Perempuan</label>
        ...
        <div>
            <label for="status"
                class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Pilihan: Aktif, Tidak
                Aktif</label>
