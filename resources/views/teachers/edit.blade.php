...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
            ...
            <div>
                <label for="nip"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Contoh: 198501012024</label>
                <input type="text" id="nip" name="nisp value="2024001"
                    class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm focus:border-[#A16207] focus:bg-white focus:outline-none">
            </div>

            <div>
                <label for="gender"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Pilihan: Laki-laki, Perempuan</label>
            ...
            <div>
                <label for="subject"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Mata pelajaran yang diampu</label>
            ...
            <div>
                <label for="phone_number"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Contoh: 08123456789</label>
            ...
            <div>
                <label for="status"
                    class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Pilihan: Aktif, Tidak Aktif</label>
